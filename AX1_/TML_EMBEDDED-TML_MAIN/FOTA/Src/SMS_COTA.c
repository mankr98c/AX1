...
//					sprintf(opBuffer, "%s Unknown parameter:",parameter);
				...
				sprintf(opBuffer, "%s Update Done",parameter);
			} else {
			...
			printc(MinDelay,"parameter and value not specified for SET or GET command.\n");
			return false;
		}
	} else {
...
void FeedAllConfig() {
	...
	HAL_FLASH_Write_Buff(CKEY1_ADDR, (uint64_t*) Rconfig.CKEY1,strlen(Rconfig.CKEY1));
	HAL_FLASH_Write_Buff(CKEY2_ADDR, (uint64_t*) Rconfig.CKEY2,strlen(Rconfig.CKEY2));
	HAL_FLASH_Write_Buff(CKEY3_ADDR, (uint64_t*) Rconfig.CKEY3,strlen(Rconfig.CKEY3));
	HAL_FLASH_Write_Buff(CKEY4_ADDR, (uint64_t*) Rconfig.CKEY4,strlen(Rconfig.CKEY4));
	HAL_FLASH_Write_Buff(CKEY5_ADDR, (uint64_t*) Rconfig.CKEY5,strlen(Rconfig.CKEY5));
	HAL_FLASH_Write_Buff(CKEY6_ADDR, (uint64_t*) Rconfig.CKEY6,strlen(Rconfig.CKEY6));
	HAL_FLASH_Write_Buff(CKEY7_ADDR, (uint64_t*) Rconfig.CKEY7,strlen(Rconfig.CKEY7));
	HAL_FLASH_Write_Buff(CKEY8_ADDR, (uint64_t*) Rconfig.CKEY8,strlen(Rconfig.CKEY8));
