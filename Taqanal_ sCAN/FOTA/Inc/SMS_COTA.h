...
#define LAT_ADDR									((uint32_t)0x0816A540)
#define LON_ADDR									((uint32_t)0x0816A560)

#define SMS_NUM_Addr								((uint32_t)0x0816A580)
#define RTC_timer_addr								((uint32_t)0x0816A600)

#define FL_On_Sl_Addr								((uint32_t)0x0816A660)
...
bool SET_LAT(char *lat);
bool SET_LON(char *lon);
